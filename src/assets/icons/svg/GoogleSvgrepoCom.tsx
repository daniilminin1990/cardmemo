...
const SvgGoogleSvgrepoCom = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
    fill={'none'}
    height={'1em'}
    ref={ref}
    ...
    {...props}
  >
    <g clipPath={'url(#google-svgrepo-com_svg__a)'}>
      <path
        d={
    ...
    <defs>
      <clipPath id={'google-svgrepo-com_svg__a'}>
        <path d={'M0 0h24v24H0z'} fill={'#fff'} />
      </clipPath>
    </defs>
  </svg>
)
const ForwardRef = forwardRef(SvgGoogleSvgrepoCom)
