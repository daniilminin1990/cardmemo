...
const SvgFunnelOutline = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
    fill={'none'}
    height={24}
    ref={ref}
    ...
    {...props}
  >
    <g clipPath={'url(#funnel-outline_svg__a)'}>
      <path
        d={
    ...
    <defs>
      <clipPath id={'funnel-outline_svg__a'}>
        <path d={'M0 0h24v24H0z'} fill={'currentcolor'} />
      </clipPath>
    </defs>
  </svg>
)
const ForwardRef = forwardRef(SvgFunnelOutline)
