...
const SvgSheldIconFilledComponent = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
    height={'1em'}
    ref={ref}
    version={'1.1'}
    ...
    {...props}
  >
    <g fill={'none'} fillRule={'evenodd'} id={'🔍-Product-Icons'} stroke={'none'} strokeWidth={'0'}>
      <rect
        fill={'#000000'}
        height={'28.80'}
        rx={'14.4'}
    ...
    <g id={'ic_fluent_incognito_24_filled'} strokeLinecap={'round'} strokeLinejoin={'round'} />
    <g id={'SVGRepo_iconCarrier'}>
      ...
      <g
        ...
        strokeWidth={'1'}
      >
        <g fill={'#ffffff'} fillRule={'nonzero'} id={'ic_fluent_incognito_24_filled'}>
          <path
            d={
...
const ForwardRef = forwardRef(SvgSheldIconFilledComponent)
