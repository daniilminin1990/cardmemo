...
import btnsStyle from '../../pages/decksList1/decks/btns/deckBtns.module.scss'
import deckStyle from '../../pages/decksList1/decks/deck/deck.module.scss'
import s from './table.module.scss'
import cardBtnsStyle from 'src/components/pages/cardsList/btns/cardBtns.module.scss'
import cardStyle from 'src/components/pages/cardsList/card/card.module.scss'
